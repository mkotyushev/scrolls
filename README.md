...
3. apex: `cd lib && git clone https://github.com/NVIDIA/apex && cd apex && git checkout 82ee367f3da74b4cd62a1fb47aa9806f0f47b58b && CC='/usr/bin/gcc-9' CXX='/usr/bin/g++-9' pip install -v --disable-pip-version-check --no-cache-dir --global-option="--cpp_ext" --global-option="--cuda_ext" ./`
